package com.example.steven.perfecttoilettime2;
...
public class MapsActivity extends FragmentActivity implements OnCameraMoveStartedListener,
        ...
        ref.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot snapshot) {
                ...
                for (DataSnapshot child : snapshot.getChildren()) {//iterate through all bathrooms and get bathroom name, latitude, and longitude
                    ...
                    Pair<LatLng, String> pair = new Pair<LatLng, String>(latlng,BathroomName);
                    locationsFromDb.add(pair);
